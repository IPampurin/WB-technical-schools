...
func TestConsumerAPIIntegration(t *testing.T) {
	...
	originTopic := topicNameConst
	originGroupID := groupIDNameConst
	...
	t.Cleanup(func() {
		topicNameConst = originTopic
		groupIDNameConst = originGroupID
	...
	// подменяем настройки
	topicNameConst = testTopic
	groupIDNameConst = testGroupID
