...
- 1main.go - некорректное решение (числа выводятся, но нет контроля остановки горутин)
- 2main.go - решение с применением паттерна на основе канала done (остановка по времени)
